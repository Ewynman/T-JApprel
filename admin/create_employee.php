...
<head>
    <title>Admin - Create Employee</title>
...
<body>
    ...
    <div class="input-group">
		<label>SSn #</label>
		<input type="password" name="SSN" value="<?php echo $SSN; ?>" required>
	</div>
    <div class="input-group">
    ...
    <div class="input-group">
		...
		<input type="text" name="Dnumber" value="<?php echo $Dnumber; ?>" required>
	</div>
    <div class="input-group">
        ...
        <div class="input-group">
            <button type="submit" class="btn" name="emp_register_btn"> + Create Employee</button>
        </div>
    </form>
</body>
