...
<html>
<head>
	<title>Admin | Modify User Info</title>
...
<form method="post" action="">
  ...
  <label for="street_add">Street Address:</label><br>
  <input type="text" id="street_add" name="street_add"><br><br>
  <input type="submit" value="Modify" name="modify_bttn">
</form> 
</body>
</html>